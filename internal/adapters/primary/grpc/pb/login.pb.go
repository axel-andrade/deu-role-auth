...
type LoginResponse struct {
	...
	RefressToken string `protobuf:"bytes,2,opt,name=refress_token,json=refressToken,proto3" json:"refress_token,omitempty"`
}
...
func (x *LoginResponse) GetRefressToken() string {
	if x != nil {
		return x.RefressToken
	}
	return ""
}
...
var file_login_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x73, 0x73, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x0c, 0x72, 0x65, 0x66, 0x72, 0x65, 0x73, 0x73, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x42, 0x0c,
